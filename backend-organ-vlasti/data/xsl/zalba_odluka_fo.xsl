               						...
               						<fo:block>
										...
										<fo:basic-link>
				               				<xsl:attribute name="external-destination">
				               					<xsl:value-of select="concat('http://localhost:4200/pdf/zahtevi/', substring-after(zalba:PodaciZahteva/@href, 'https://github.com/draganagrbic998/xml/zahtev/'))"></xsl:value-of>
				               				</xsl:attribute>
										...
										<fo:basic-link>
				               				<xsl:attribute name="external-destination">
				               					<xsl:value-of select="concat('http://localhost:4200/pdf/odluke/', substring-after(zalba:PodaciOdluke/@href, 'https://github.com/draganagrbic998/xml/odluka/'))"></xsl:value-of>
				               				</xsl:attribute>
				               				<xsl:attribute name="color">
												blue
				               				</xsl:attribute>
