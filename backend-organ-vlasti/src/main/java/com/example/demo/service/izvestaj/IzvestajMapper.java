...
public class IzvestajMapper {
	...
	public Document map(String godina) throws XMLDBException {
		...
		bzodlNode.setTextContent(
				Long.toString(this.zalbaExist.retrieve("/zalba:Zalba[@xsi:type='zalba:TZalbaOdluka']").getSize()));
