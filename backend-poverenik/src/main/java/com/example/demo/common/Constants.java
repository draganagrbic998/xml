...
public class Constants {
	...
	public static final String DATA_FOLDER = "data" + File.pathSeparatorChar;
	public static final String XSD_FOLDER = DATA_FOLDER + "xsd" + File.separatorChar;
	public static final String XSL_FOLDER = DATA_FOLDER + "xsl";
	public static final String INIT_FOLDER = DATA_FOLDER + "init" + File.separatorChar;
	public static final String GEN_FOLDER = DATA_FOLDER + "gen";
	public static final String SPARQL_FOLDER = DATA_FOLDER + "sparql";
