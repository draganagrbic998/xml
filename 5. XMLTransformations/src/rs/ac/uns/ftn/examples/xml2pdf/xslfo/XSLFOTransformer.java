package rs.ac.uns.ftn.examples.xml2pdf.xslfo;
...
public class XSLFOTransformer {
	...
	public static final String INPUT_FILE = "data/xsl-fo/ZahtevDostava.xml";
	
	public static final String XSL_FILE = "data/xsl-fo/Zahtev_fo.xsl";
	
	public static final String OUTPUT_FILE = "gen/fo/zahtev.pdf";
